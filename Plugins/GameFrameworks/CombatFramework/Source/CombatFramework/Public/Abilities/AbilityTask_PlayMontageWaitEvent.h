...
public:
	...
	/** The montage completely blended in */
	UPROPERTY(BlueprintAssignable)
	FMontageWaitEventDelegate OnBlendIn;
...
protected:
	void OnMontageBlendedInEnded(UAnimMontage* Montage);
...
private:
	...
	FOnMontageBlendedInEnded BlendingInDelegate;
